...
public class TC037_printpicklist_nextday {
...
public void f() throws InterruptedException {
	 ...
	 driver.findElement(By.name("xml:/Shipment/ShipmentLines/ShipmentLine/@OrderNo")).sendKeys(OrderNumVariables.DHL_Ordernum[2],Keys.ENTER);
	 Thread.sleep(3000);
