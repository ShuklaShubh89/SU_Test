...
public class TC025_outboundsingle_pre4hr {
...
public void f() throws InterruptedException, IOException {
		...
		Date date1 = new Date();
		String ordernum = dateFormat.format(date1);
		...
		dropdown3.selectByValue("PRE 4 HR");
		Thread.sleep(1000);
	    ...
	    WebElement e2 = (new WebDriverWait(driver, 50)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(),'"+ordernum+"')]")));
	    ...
	    String order = dhlordernum.getText();
	    OrderNumVariables.DHL_Ordernum[0] =order;
	    System.out.println("DHL_Ordernum[0] = "+order);
	    driver.quit();
